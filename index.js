...
const { newUser, removeUser, getRoomUsers, getUser } = require("./server/utils");
...
io.on('connection', (socket) => {
  ...
  // when someone leaves, if leader left the permission will be given to someone else (users[0])
